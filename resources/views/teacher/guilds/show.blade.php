<x-layouts.app :title="__('Detalle del Gremio - Docente')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('teacher.guilds.edit', $guild) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Misiones</h3>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">0</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Tareas</h3>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">0</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <div class="p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Información del Gremio</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900 dark:text-white font-medium">{{ $guild->name }}</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Código de Activación</label>
                            <div class="mt-1 flex items-center">
                                ...
                                <button onclick="copyToClipboard('{{ $guild->code }}')"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">ID del Gremio</label>
                            <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $guild->id }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                            <p class="text-sm text-gray-900 dark:text-white">
                                {{ $guild->description ?: 'No hay descripción disponible.' }}
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function copyToClipboard(text) {
            navigator.clipboard.writeText(text).then(function() {
                ...
                button.innerHTML = '<flux:icon.check class="size-4" />';
                setTimeout(() => {
