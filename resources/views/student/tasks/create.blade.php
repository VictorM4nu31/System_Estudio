<x-layouts.app :title="__('Crear Tarea - Estudiante')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        <!-- Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Crear Tarea</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Crea una nueva tarea para estudiantes</p>
            </div>
