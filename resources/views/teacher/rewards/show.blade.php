<x-layouts.app :title="__('Detalle de la Recompensa - Docente')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    <div class="p-2 bg-blue-100 dark:bg-blue-900/50 rounded-lg">
                        <flux:icon.currency-dollar class="size-6 text-blue-600 dark:text-blue-400" />
                    </div>
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Costo</h3>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $reward->cost }} pts</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Compras</h3>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Disponible</h3>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">Sí</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <div class="p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Información de la Recompensa</h2>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Basic Info -->
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Nombre de la Recompensa</label>
                            <p class="mt-1 text-sm text-gray-900 dark:text-white font-medium">{{ $reward->name }}</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">ID de la Recompensa</label>
                            <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $reward->id }}</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Tienda</label>
                            <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $reward->shop->name ?? 'No asignada' }}</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Gremio</label>
                            <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $reward->guild->name ?? 'No asignado' }}</p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                                <p class="text-sm text-gray-900 dark:text-white">
                                    {{ $reward->description ?: 'No hay descripción disponible.' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100">
                            <flux:icon.shopping-cart class="size-4 mr-2" />
                            Ver Compras
                        </a>
