<x-layouts.app :title="__('Crear Gremio - Estudiante')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        <!-- Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Crear Gremio</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Crea un nuevo gremio para estudiantes</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <form action="{{ route('student.guilds.store') }}" method="POST">
                @csrf
